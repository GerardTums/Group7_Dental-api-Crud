        ...
        <Box sx={{height: 550, width: 500, boxShadow: 'black 0px 0px 20px', borderRadius: 2}}>
            ...
            <Box component="form" onSubmit={onSubmit} sx={{width: 300, mx: 'auto'}}>
                <Box sx={{mt: 1}}>
                    ...
                    {
                       warnings?.name ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.name}</Typography>
                        ) : null
                    }
                </Box>
                <Box sx={{mt: 1}}>
                    ...
                    {
                       warnings?.email ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.email}</Typography>
                        ) : null
                    }
                </Box>
                <Box sx={{mt: 1}}>
                    ...
                    {
                       warnings?.password ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.password}</Typography>
                        ) : null
                    }
                </Box>
                <Box sx={{mt: 1}}>
                ...
                <Box sx={{mt: 1}}>
                    ...
                    {
                       warnings?.first_name ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.first_name}</Typography>
                        ) : null
                    }
                </Box>
                <Box sx={{mt: 1}}>
                    ...
                    {
                       warnings?.last_name ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.last_name}</Typography>
                        ) : null
                    }
                </Box>
                <Box sx={{mt: 1}}>
                    <TextField id="middle_name" fullWidth size="small" label="Middle Name" />
                    {
                       warnings?.middle_name ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.middle_name}</Typography>
                        ) : null
                    }
                </Box>
                <Box sx={{mt: 1}}>
                    ...
                    {
                       warnings?.birth_date ? (
                            <Typography sx={{fontSize: '8'}} component="small" color="error">{warnings.birth_date}</Typography>
                        ) : null
                    }
                </Box>
